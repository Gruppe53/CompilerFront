...
public interface MiniJavaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MiniJavaParser#expressionIntArray}.
	 * @param ctx the parse tree
	 */
	void enterExpressionIntArray(@NotNull MiniJavaParser.ExpressionIntArrayContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniJavaParser#expressionIntArray}.
	 * @param ctx the parse tree
	 */
	void exitExpressionIntArray(@NotNull MiniJavaParser.ExpressionIntArrayContext ctx);
	...
	/**
	 * Enter a parse tree produced by {@link MiniJavaParser#expressionIdent}.
	 * @param ctx the parse tree
	 */
	void enterExpressionIdent(@NotNull MiniJavaParser.ExpressionIdentContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniJavaParser#expressionIdent}.
	 * @param ctx the parse tree
	 */
	void exitExpressionIdent(@NotNull MiniJavaParser.ExpressionIdentContext ctx);
}